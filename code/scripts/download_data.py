#!/usr/bin/env python3
"""Fetch and authenticate the original data for Matrix-Free Covariance Scaling for Recorded Ground-Motion Signals."""
...
BASE_COMMAND = ["taskbutterfly-reproduce","--verify"]
